...
excluded_hetids = {
    'NAP', 'MA4', 'EOH', 'AGC', 'EOM', 'BGC', 'HEM', 'CPS', 'CPT', 'TAU', 'TAR', 'TAS', 'SPK', '1FH',
    'SPM', 'VA3', 'SPD', 'XPE', 'GD', 'GA', 'EHN', 'CO5', 'LAK', 'V70', 'PE4', 'MAC', 'LAT', 'CP2',
    'CP3', 'AR', 'MAN', 'CMO', 'TSM', 'DTN', 'TSD', 'TSE', 'YBT', 'EDO', 'PCL', 'CB5', 'BEQ', 'F09',
    'DTV', 'NO2', 'NO3', 'DZZ', 'IUM', 'UVW', 'NME', 'ZN', 'NFC', 'NFB', 'NFO', 'K', 'OH', 'NFS', 'NFR',
    'MQD', 'MG', 'CBG', 'NOE', 'MO', 'MN', 'PC4', 'CBM', 'SE', 'CBX', 'MXE', 'BE7', 'BCT', 'DCE', 'W',
    'GLO', 'MM4', 'GLC', 'DOD', 'SMO', 'GLY', 'DOX', 'FE', 'OF2', 'DET', 'C2C', 'FCY', 'MDD', 'AU3',
    'FCL', 'FCO', 'HTG', 'AUC', 'VER', 'F', 'NFE', 'FMT', 'FMS', 'JEF', 'V', 'TOU', 'SX', 'OF3', 'SBT',
    'SR', 'SBY', 'LMT', 'LMU', 'T3A', 'SM', 'SBE', 'SB', 'SBO', 'MMC', 'YH', 'DPR', 'YB', 'CAT', 'DPG',
    'DPO', 'CAC', 'TF4', 'CAD', 'NHE', 'PGE', 'LA', 'PGO', 'PGL', 'HG2', 'LI', 'LU', 'PGR', 'PGQ', 'NHY',
    '144', 'NMU', 'PG6', 'NH4', 'WCC', 'PG5', 'ZRC', 'PG0', 'B7G', 'HGC', 'CFN', 'CFO', 'CFM', 'TFH',
    'NCP', 'I42', 'TFA', 'PNL', 'NCO', 'Y1', 'CFT', 'KO4', 'SF4', 'ZNH', 'ZNO', 'SF3', 'FNE', 'EGL',
    '7PE', 'RU', 'LBT', 'SAL', 'RE', 'RB', 'BF4', 'URE', 'MRY', 'CHM', 'ACM', 'MRD', 'IPA', 'IPH', 'ZN3',
    'ZN2', 'ZN1', 'LI1', '4OA', 'RHD', 'OCM', 'OCL', 'OCO', 'OCN', 'NGN', 'HDZ', 'P2K', 'V40', 'HDD',
    'HDN', 'MG8', 'BMA', '2FU', 'BME', 'WO5', 'WO4', 'OX', 'YT3', 'WO2', 'CEQ', '2FH', 'AF3', 'ENC',
    'GCD', '2HP', 'B3P', 'CE1', 'EU', 'XCC', 'MGF', 'TBR', 'TBU', 'PG4', 'OC8', 'BTC', 'BTB', 'OC1',
    'OC3', 'OC2', 'OC5', 'OC4', 'OC7', 'OC6', 'NH3', '3OF', 'ATO', 'HGI', 'DMF', 'AST', 'MTG', 'SEA',
    'SEK', 'GBL', 'EU3', 'CLN', 'CLO', 'DUM', 'UNX', 'BEF', 'CLF', 'PDT', 'XE', 'PDO', 'TLA', 'CLX',
    'DMN', 'FRU', 'BBX', 'BBU', 'CLP', 'OMO', 'H2S', 'ZEM', 'KR', 'SRM', 'SE4', 'P6G', '2ME', '2MO',
    'CYS', '3PO', 'POR', 'POP', 'PON', '2BM', 'CYN', 'GOL', '202', 'F50', 'DHE', 'DHD', 'PO2', 'PO3',
    'MLP', 'OTE', 'TFP', 'E1H', 'MCR', 'NRU', '3CO', '3CN', '2PA', '2PE', 'NI2', 'NI3', 'NI1', '2PO',
    '2PN', 'TCN', 'HSG', 'HSH', 'TZZ', '12P', '543', 'OF0', 'OF1', 'HSW', 'C2O', 'MEE', 'N2O', 'PD',
    'VXA', 'GPX', 'THJ', 'BNG', 'NIK', 'F2O', 'SYL', 'CCH', 'FDE', 'FDD', 'EMC', 'MO3', 'MO2', 'MO1',
    'CRY', 'MO7', 'MO6', 'MO5', 'MO4', 'DMS', 'DMU', 'DMX', 'RGI', 'AEM', 'PS5', 'PR', 'LDA', 'PT', 'PB',
    'ZO3', 'TCH', 'PI', 'MH2', 'MH3', 'MHM', 'BU2', 'BU3', 'DDQ', 'BU1', 'MHA', 'S', 'DDH', 'T1A', 'LCP',
    'MOS', 'O4M', 'MOH', 'MOO', 'LCO', 'BCN', 'UMQ', 'NH2', 'HNI', 'PEU', 'PER', 'FSO', 'TMA', 'ETA',
    'ETF', 'CD1', 'PEJ', 'CD3', 'FSX', 'DVT', 'PEG', 'COM', 'RU7', 'CON', 'HE5', 'HE6', 'BF2', '16D',
    '16A', 'P33', 'ND4', 'HEV', 'CO', 'CN', 'CM', 'HES', 'CA', 'HEZ', 'CD', 'HEG', 'HEA', 'HEB', 'HEC',
    'CS', 'CR', 'CU', 'IOD', 'PE8', 'PSL', 'OES', 'PE5', 'PE7', 'PE3', 'FS1', 'FS2', 'FS3', 'FS4', 'PC3',
    'OEC', 'NMO', 'NML', 'DIO', '6MO', 'CIT', 'DIA', 'C8E', '1PS', 'C10', 'C15', 'DIS', 'PPF', 'SOG',
    'PPK', 'SOH', 'PPI', 'IR3', 'SOM', 'TBA', 'PPM', 'SOR', 'PPV', 'GAI', 'XL1', 'MBR', 'IR', '3NI',
    'IRI', 'SO3', 'SO2', 'SO4', 'MTL', 'IN', 'VX', 'PP9', 'MTF', 'CM5', 'MTD', 'ARS', 'ART', 'SDS',
    'ARF', '4MO', 'BA', 'NAO', 'CCN', 'NAW', 'BR', 'EPE', 'O2', 'BOG', 'PIN', 'MYQ', 'MYR', 'POL', 'PIG',
    'N8E', 'F3S', 'IOH', 'PIS', 'CD5', 'BO3', 'BO4', 'DR6', 'NA2', 'PEO', 'NA6', 'CXE', 'NA5', 'OS',
    'REO', 'U1', 'VO4', 'FLH', 'HO', 'FLO', 'COH', 'EEE', 'HG', 'PTN', 'ETI', 'SFO', 'ETN', 'MNR', 'VO3',
    'MNH', 'OSM', 'ROP', 'SFN', 'MNC', 'PO4', '3BR', 'FMI', 'MN3', 'TRE', 'MN5', 'O', 'PBM', 'TRS',
    'PT4', 'TRT', 'MW3', 'MW2', 'MPD', 'HTO', 'MPO', 'MTO', '6WO', 'MPR', 'MPS', 'AU', 'OXY', 'ACA',
    'GD3', 'SUC', 'NEH', 'IDT', 'SUL', 'P4C', 'ACN', '2OF', 'S0H', 'IDO', 'HFM', 'ACU', 'ACT', '2OP',
    'ACY', '2OS', 'NI', 'CU1', 'NO', 'NA', 'MW1', 'TEE', 'FE2', 'TEP', '1BO', 'FEC', 'FEA', 'FEO', 'FEL',
    'CUZ', 'FES', 'CUA', 'CUO', 'CUN', 'CUM', 'CUL', 'PTL', 'MN6', 'BRP', 'BRO', 'BRM', 'BRJ', 'MES',
    'OUT', 'AZI', 'MP1', '1PG', '1PE', 'MSM', 'HLT', 'MSF', 'CN1', 'CL', 'TL', 'SGM', 'HO3', 'TE', 'TB',
    'ICI', 'AG', 'FPO', '1CP', 'AL', 'HOH', 'CNF', 'SCN', 'CNB', 'CE', 'CNN', 'CNM', 'ICT', '15P', 'ZH3',
    'RTC', '2NO', 'DXG', 'DXE', 'VSO', 'MSE', 'FAR', 'FII', 'FPP', 'HFP', 'A4P', 'NAD', 'ADP', 'AMP',
    'APC', 'ATP', 'IMP', 'RVP', 'XMP', 'SAH', 'SAM', 'FAD', 'NAP', 'NDP', 'UDP', 'ANP', 'COA', 'CME',
    'UMP', 'NAI'
}
...
def get_sdf_hetid(pdbid: str, hetid: str, pdb_lig_filename: str) -> bool:
    """Downloads ligand sdf file using RCSB ligand expo API."""

    hetid = str(hetid)
    sflag = False
    url = "https://ligand-expo.rcsb.org/files/%s/%s/isdf/" % (
        hetid[0], hetid)
...
def get_smi_from_hetid(hetid: str) -> str:
...
def get_3d_sdf_from_smi(smi: str, sdf_filename: str) -> bool:
...
def get_hetids_from_pdbid(pdbid: str) -> list[str]:
    """
...
def write_conformers(mol_input: str, mol_reference: str, conf_file: str):
    """
    ...
    if conformers:
        best_rmsd = [
            MolecularDescriptors.rmsd(
                mol_reference, c.molecule, None, True, True, True
            )
            for c in conformers
        ]
        best_rmsd.sort()
...
def generate_conformers_for_all_hetids(pdbid: str, folder_path: str = 'conformers_'):
    """
